...
shinyServer(function(input, output, session) {
  ...
  output$about_text2 <- renderUI({
    ...
    link4 <- a("the R file", "https://github.com/ericwarren9/ST-558-Project-4/blob/main/File%20to%20Combine%20Data%20into%20One%20Source.R")
    link5 <- a("CSV file", "https://github.com/ericwarren9/ST-558-Project-4/blob/main/player_stats_and_salary.csv")
    link6 <- a("RDS file", "https://github.com/ericwarren9/ST-558-Project-4/blob/main/player_stats_and_salary.rds")
